...
APIKEY= "20dd52bf2ecf8760ea8f1f11d854e0fc"


let url = 'https://api.openweathermap.org/data/2.5/weather?q=Pompey&appid=20dd52bf2ecf8760ea8f1f11d854e0fc&units=metric&lang=fr';
...
function panierappear() {
	 var panier = document.getElementById("paniersecret");
	 panier.classList.toggle("panierpop")
	}

function achat(){
	document.getElementsByClassName("achat");
